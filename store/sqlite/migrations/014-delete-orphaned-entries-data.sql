...
-- This can happen if entries were deleted but their data chunks weren't cleaned up.
...
-- This can happen if entries were deleted but their download history wasn't cleaned up.
...
-- Set guest_link_id to NULL for entries that reference non-existent guest links.
